...
@Component({
  selector: 'app-fraud-transactions-history-avalanche',
  templateUrl: './fraud-transactions-history-avalanche.component.html',
  styleUrl: './fraud-transactions-history-avalanche.component.css'
})
export class FraudTransactionsHistoryAvalancheComponent {
